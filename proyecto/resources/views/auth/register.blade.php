        ...
        <div id="login-row" class="row justify-content-center align-items-center">
            <div id="login-column" class="col-xs-12 col-md-8">
                <div id="login-box" class="col-md-12">
                    <form id="login-form" class="form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data" >
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="carnet" id="carnet" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="foto" class="text-info">Foto carnet</label>
                            <input type="file" class="form-control-file" name="foto" id="foto" accept="image/jpeg, image/jpg, image/png, image/bmp" required>
                        </div>
                        <div class="form-group">
